        ...
        <div class="container table-responsive content-panel bg-light p-3 shadow">
            ...
            <table class="table table-bordered my-table">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>Dr. Abhay Lingayat, Asst. Professor,<br> PG Coordinator - Heat Power Engineering</td>
                        <td>Subject Head</td>
                        <td>Ex-officio</td>
                    </tr>
                    <tr>
            ...
            <div class="section-2">
                ...
                <p>
                    ...
                    <a target="_blank" href="../vender/files/bos_minute_meet/MOM_BoS_3_dated 12.10.2021.pdf">Minutes of Meeting (Dt. 12 Oct 2021)</a><br>
                    <a target="_blank" href="../vender/files/bos_minute_meet/MOM_of_4th_BOS_meeting.PDF">Minutes of Meeting (Dt. 09 June 2022)</a><br>
                    <a target="_blank" href="../vender/files/bos_minute_meet/5th BOS meeting MOM_dated 18 Jan 2023.pdf">Minutes of Meeting (Dt. 18 Jan 2023)</a><br>
                </p>
            </div>
        </div>
    </div>
