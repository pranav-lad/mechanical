...
<head>
    ...
    <title>Home | Department Of Mechanical Engineering | PCCOE</title>
    <meta name="description" content="Home page for Mechanical Engineering Department, Pimpri Chinchwad College Of Engineering, Pune">
 <meta name="keywords" content="best, mechanical, engineering, department, pune, pimpri, chinchwad, college">
    <style>
        html {
    ...
    <!--div class="marquee-section">
        <div class="running-text">
            ...
            <marquee scrollamount="8" class="p-1" onmouseover="this.stop();" onmouseout="this.start();">
                <a class="text-decoration-none text-dark" target="_blank" href="https://drive.google.com/file/d/1bTh4iMkT1kt6HfkMPSeMJnP0Ajt2PTU8/view?usp=sharing">
                    <span class="marquee-text mar_link">
                        I-MACE 2022 International conference on innovation in Mechanical & Civil Engineering <b> Final call for papers<b>.
                    </span>
                </a>
    ...
    <div id="carouselExampleCaptions" class="carousel slide carousel-fade" interval="100" data-bs-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="vender/img/slider/img-0.webp" class="d-block w-100" alt="..." />
                <div class="carousel-caption pb-0">
                    <span class="title">1/13</span>
                </div>
            </div>
            <div class="carousel-item">
                <img src="vender/img/slider/img-1.webp" class="d-block w-100" alt="..." />
                <div class="carousel-caption pb-0">
                    <span class="title">2/13</span>
                </div>
            </div>
            <div class="carousel-item">
                <img src="vender/img/slider/img-2.webp" class="d-block w-100" alt="..." />
                <div class="carousel-caption pb-0">
                    <span class="title">3/13</span>
                </div>
            </div>
            <div class="carousel-item">
                <img src="vender/img/slider/i-1.webp" class="d-block w-100" alt="..." />
                <div class="carousel-caption pb-0">
                    <span class="title">4/13</span>
                </div>
            </div>
            <div class="carousel-item">
                <img src="vender/img/slider/new slide mech.png" class="d-block w-100" alt="..." />
                <div class="carousel-caption pb-0">
                    <span class="title">5/13</span>
                </div>
            </div>
            <div class="carousel-item">
                <img src="vender/img/slider/u1.webp" class="d-block w-100" alt="..." />
                <div class="carousel-caption pb-0">
                    <span class="title">6/13</span>
                </div>
            </div>
            <div class="carousel-item">
                <img src="vender/img/slider/img-3.webp" class="d-block w-100" alt="..." />
                <div class="carousel-caption pb-0">
                    <span class="title">7/13</span>
                </div>
            </div>
            <div class="carousel-item">
                <img src="vender/img/slider/kratos.webp" class="d-block w-100" alt="..." />
                <div class="carousel-caption pb-0">
                    <span class="title">8/13</span>
                </div>
            </div>
            <div class="carousel-item">
                <img src="vender/img/slider/img-4.webp" class="d-block w-100" alt="..." />
                <div class="carousel-caption pb-0">
                    <span class="title">9/13</span>
                </div>
            </div>
            <div class="carousel-item">
                <img src="vender/img/slider/slide1.png" class="d-block w-100" alt="..." />
                <div class="carousel-caption pb-0">
                    <span class="title">10/13</span>
                </div>
            </div>
            <div class="carousel-item">
                <img src="vender/img/slider/silde2.png" class="d-block w-100" alt="..." />
                <div class="carousel-caption pb-0">
                    <span class="title">11/13</span>
                </div>
            </div>
            <div class="carousel-item">
                <img src="vender/img/slider/slide3.png" class="d-block w-100" alt="..." />
                <div class="carousel-caption pb-0">
                    <span class="title">12/13</span>
                </div>
            </div>
            <div class="carousel-item">
                <img src="vender/img/slider/slide4.png" class="d-block w-100" alt="..." />
                <div class="carousel-caption pb-0">
            ...
            <div class="col-lg-3 justify-content-center">
                <div class="section bg-light">
                    ...
                    <ul class="section-list">
                        ...
                        <a href="student_corner/alumni.php">
                            <li>Alumni</li>
                        </a>
                    </ul>
                </div>
            ...
            <div class="col-lg-9">
                <div class="container-fluid p-3 mt-2 about-section bg-light rounded">
                    ...
                    <div class="row mt-4">
                        ...
                        <iframe width="100%" height="225" src="https://www.youtube.com/embed/WYMosExQLgs" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                        </div>
                ...
                <div class="row mt-3">
                    ...
                    <a target="_blank" href="vender/files/notices/PCCOE-Examination Circular Third Year Engineering (2019 Pattern) SEM-I Insemester Examination Time 10.00 am To 10.40 am.pdf">
                      ...
                      <a target="_blank" href="vender/files/notices/TY B Tech  MTE Time Table.pdf">
                          <li>
                              <small>TY B Tech MTE Time Table</small>
                          </li>
                      </a>
                      <a target="_blank" href="vender/files/notices/Guidelines for TY B Tech MTE 2022-23.pdf">
                          <li>
                              <small>TY B Tech MTE guidelines</small>
                          </li>
                      </a>
                      <!-- <a target="_blank" href="vender/files/notices/Parent meet notice 22-23 sem I.pdf">
                                                <li>
                                                    <small>Parent meet notice 2022-23 Sem 1</small>
                                                </li>
                                            </a> -->
                                            <!-- <a target="_blank" href="vender/files/notices/SY B Tech_MTE Time Table and Guidelines_Exam 2022.pdf">
                                                <li>
                                                    <small>SY B Tech MTE Time Table and guidelines</small>
                                                </li>
                                            </a> -->
                                            <!-- <a target="_blank" href="vender/files/notices/SY Btech Induction Program Schedule (2).pdf">
                                                <li>
                                                    <small>Commencement of Second Year Induction program of S.Y. 2022-23</small>
                                                </li>
                                            </a> -->
