    ...
    <div class="container p-2 department-boucher bg-light mt-3">
        <div class="pt-4">
            <ul class="fa-ul">
                ...
                <li><span class="fa-li"><i class="fas fa-arrow-circle-right"></i></span> 
                  <a target="_blank" href="../vender\files\department_boucher\April_Draft_v5_13042022.pdf">
                    Samvaad Volume 2 Issue 1
                  </a>
                </li>
                <li><span class="fa-li"><i class="fas fa-arrow-circle-right"></i></span> 
                  <a target="_blank" href="../vender\files\department_boucher\Samvaad Vol 2 Issue 3, June 2022.pdf">
                    Samvaad Volume 2 Issue 3
                  </a>
                </li>
                <li><span class="fa-li"><i class="fas fa-arrow-circle-right"></i></span> 
                  <a target="_blank" href="../vender\files\department_boucher\Samvaad, Volume 2, Issue 4, July 2022.pdf">
                    Samvaad Volume 2 Issue 4
                  </a>
                </li>
                <li><span class="fa-li"><i class="fas fa-arrow-circle-right"></i></span> 
                  <a target="_blank" href="../vender\files\department_boucher\Samvaad Vol 2 Issue 5, Aug 2022.pdf">
                    Samvaad Volume 2 Issue 5
                  </a>
                </li>
                <li><span class="fa-li"><i class="fas fa-arrow-circle-right"></i></span> 
                  <a target="_blank" href="../vender/files/department_boucher/Samvaad, Volume 2, Issue 6, September 2022.pdf">
                    Samvaad Volume 2 Issue 6
                  </a>
                </li>
                <li><span class="fa-li"><i class="fas fa-arrow-circle-right"></i></span> 
                  <a target="_blank" href="../vender/files/department_boucher/Samvaad, Volume 2, Issue 7, October 2022.pdf">
                    Samvaad Volume 2 Issue 7
                  </a>
                </li>
            </ul>
        </div>
