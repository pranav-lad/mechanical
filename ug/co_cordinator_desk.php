      ...
      <div class="row justify-content-around">
        <div class="col-lg-3 col-sm-6">
          <div class="item    text-center">
            <div class="text-center"><img src="../faculty photo\Neeta_A_Mandhare.jpg"></div>
            <h6 class="h6 text-center">Dr. N. A. Mandhare</h6>
        ...
        <div class="col-lg-3 col-sm-6">
          <div class="item    text-center">
            <div class="text-center"><img src="../faculty photo\SRWankhede.jpg"></div>
        ...
        <div class="col-lg-3 col-sm-6">
          <div class="item    text-center">
          <div class="text-center"><img src="../faculty photo\SBMatekar.jpg"></div>
            <h6 class="h6 text-center">Dr. S. B. Matekar</h6>
  ...
  <div class="mt-5 bg-light container p-3">
    ...
    <div class="tab-content bg-white" id="myTabContent">
              ...
              <div class="accordion-body">
                <ul class="fa-ul text-primary">
                  <li><span class="fa-li"><i class="fas fa-arrow-circle-right"></i></span> <a target="_blank"
                      class="text-decoration-none" href="../vender/files/course_outline/Course Outline_NM_2023.pdf">Numerical Methods</a></li>
                  <li><span class="fa-li"><i class="fas fa-arrow-circle-right"></i></span> <a target="_blank"
                      class="text-decoration-none" href="../vender/files/course_outline/Course Outline_MO_2023 (1).pdf">Mathematical Optimization</a></li>
                  <li><span class="fa-li"><i class="fas fa-arrow-circle-right"></i></span> <a target="_blank"
                      class="text-decoration-none" href="../vender/files/course_outline/Course Outline_CoV_2023.pdf">Calculus of Variation</a></li>
                  <li><span class="fa-li"><i class="fas fa-arrow-circle-right"></i></span> <a target="_blank"
                      class="text-decoration-none" href="../vender/files/course_outline/Course Outline_NFL_2023 (1).pdf">Neural Networks and Fuzzy Logic</a></li>
                      <!-- --------------- newly added ------------  -->
                  <li><span class="fa-li"><i class="fas fa-arrow-circle-right"></i></span> <a target="_blank"
                      class="text-decoration-none" href="../vender/files/course_outline/Course Outline MMM.pdf">Metrology and Mechanical Measurement</a></li>
                  <li><span class="fa-li"><i class="fas fa-arrow-circle-right"></i></span> <a target="_blank"
                      class="text-decoration-none" href="../vender/files/course_outline/Course Outline KTM 2022-23.pdf">Kinematics and Theory of Machines</a></li>
                  <li><span class="fa-li"><i class="fas fa-arrow-circle-right"></i></span> <a target="_blank"
                      class="text-decoration-none" href="../vender/files/course_outline/Course Outline_AT_22-23_SEM II (1).pdf">Applied Thermodynamics</a></li>
                  <li><span class="fa-li"><i class="fas fa-arrow-circle-right"></i></span> <a target="_blank"
                      class="text-decoration-none" href="../vender/files/course_outline/Course Outline_CAMD.pdf">Computer Aided Machine Drawing II</a></li>
                  <li><span class="fa-li"><i class="fas fa-arrow-circle-right"></i></span> <a target="_blank"
                      class="text-decoration-none" href="../vender/files/course_outline/Course Outline_FM_2023.pdf">Fluid Mechanics</a></li>
                  <li><span class="fa-li"><i class="fas fa-arrow-circle-right"></i></span> <a target="_blank"
                ...
                <div class="container p-2 mt-1 class-teacher">
                  <div class="container-fluid content-panel">
                    <div class="row justify-content-around">
                      ...
                      <div class="col-lg-3 col-sm-6">
                        <div class="item    text-center">
                          <div class="text-center"><img src="../faculty%20photo/NJSurwade.jpg"></div>
                          <h6 class="h6 text-center">Mr N. J. Surawade</h6>
                          <p class="batch">~ SY Division-B</p>
                        </div>
                      </div>
                      <div class="col-lg-3 col-sm-6">
                        <div class="item    text-center">
                          <div class="text-center"><img src="../faculty%20photo/Dr. Masnaji Nukulwar.JPG"></div>
                          <h6 class="h6 text-center">Mr. M. R. Nukulwar</h6>
                ...
                <div class="container p-2 mt-1 class-teacher">
                  <div class="container-fluid content-panel">
                    <div class="row justify-content-around">
                      <div class="col-lg-3 col-sm-6">
                        <div class="item  text-center">
                          <div class="text-center"><img src="../people/Staff Photo/Laxmikant Raskar.jpg"></div>
                          <h6 class="h6 text-center">Mr. L. K. Raskar</h6>
                          <p class="batch">~ SY Division-A</p>
                        </div>
                      </div>
                      <div class="col-lg-3 col-sm-6">
            ...
            <div id="flush-collapseac" class="accordion-collapse collapse" aria-labelledby="flush-headingac"
              ...
              <div class="accordion-body">
                ...
                <!-- <li><span class="fa-li"><i class="fas fa-arrow-circle-right"></i></span> <a target="_blank"
                      ...
                      <li><span class="fa-li"><i class="fas fa-arrow-circle-right"></i></span> <a target="_blank"
                      class="text-decoration-none"
                      href="../vender/files/activity_calendar/Event Calndar_SY B Tech_AY 2022-23 Sem II (1).pdf">Event
                      Calendar of the Institute for SY. </a></li>
                </ul>
              </div>
            </div>
          ...
          <div class="accordion-item">
            ...
            <div id="flush-collapseThree" class="accordion-collapse collapse" aria-labelledby="flush-headingThree"
              ...
              <div class="accordion-body">
                <ul class="fa-ul text-primary">
                  <li><span class="fa-li"><i class="fas fa-arrow-circle-right"></i></span> <a target="_blank"
                      class="text-decoration-none" href="../vender/files/time_table/sy-a.jpg">S.Y. Division A </a></li>
                  <li><span class="fa-li"><i class="fas fa-arrow-circle-right"></i></span> <a target="_blank"
                      class="text-decoration-none" href="../vender/files/time_table/sy-b.jpg">S.Y. Division B </a></li>
                  <li><span class="fa-li"><i class="fas fa-arrow-circle-right"></i></span> <a target="_blank"
                      class="text-decoration-none" href="../vender/files/time_table/sy-c.jpg">S.Y. Division C </a></li>
                </ul>
              </div>
            </div>
          </div>
      ...
      <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
        <h5 class="text-center p-3">TY B. Tech</h5>
        <!-- start accordion -->
                ...
                <div class="container p-2 mt-1 class-teacher">
                  <div class="container-fluid content-panel">
                    <div class="row justify-content-around">
                      <div class="col-lg-3 col-sm-6">
                        <div class="item  text-center">
                          <div class="text-center"><img src="../faculty%20photo/Dr_ADARSH_ABI_MATHEW.jpg"></div>
                          <h6 class="h6 text-center">Dr. A. A. Mathew</h6>
                          <p class="batch">~ TE Division-A</p>
                        </div>
                      </div>
                      <div class="col-lg-3 col-sm-6">
                        <div class="item    text-center">
                          <div class="text-center"><img src="../faculty photo\Mrs-V-Y-Bhalerao.jpg"></div>
                          <h6 class="h6 text-center">Mrs. V. Y. Bhalerao</h6>
                          <p class="batch">~ TE Division-B</p>
                        </div>
                      </div>
                      <div class="col-lg-3 col-sm-6">
                        <div class="item    text-center">
                          <div class="text-center"><img src="../faculty%20photo/RBPatil.JPG"></div>
                    ...
                    <div class="row justify-content-around">
                      <div class="col-lg-3 col-sm-6">
                        <div class="item  text-center">
                          ...
                          <p class="batch">~ TY Division-A</p>
                        </div>
                      </div>
                      <div class="col-lg-3 col-sm-6">
                        <div class="item    text-center">
                          <div class="text-center"><img src="../people/Staff Photo/Avinash Tapkir.jpg"></div>
                          <h6 class="h6 text-center">Mr. A. S. Tapkir</h6>
                          <p class="batch">~ TY Division-B</p>
                        </div>
                      </div>
                      <div class="col-lg-3 col-sm-6">
                        <div class="item    text-center">
                          <div class="text-center"><img src="../people/Staff Photo/Utkarsh Sorte.jpg"></div>
                          <h6 class="h6 text-center">Mr. U. D. Sorte</h6>
                          <p class="batch">~ TY Division-C</p>
                        </div>
                      </div>
                    </div>
                  </div>
            ...
            <div id="flush-collapse1ac" class="accordion-collapse collapse" aria-labelledby="flush-heading1ac"
              ...
              <div class="accordion-body">
                <ul class="fa-ul text-primary">
                  ...
                  <li><span class="fa-li"><i class="fas fa-arrow-circle-right"></i></span> <a target="_blank"
                      class="text-decoration-none"
                      href="../vender/files/activity_calendar/Event calendar_TY B Tech Sem I 2022-23.pdf">Event  Calendar of
                      the Institute for TY B.Tech</a></li>
                </ul>
              </div>
            </div>
          </div>
            ...
            <div id="flush-collapseTwo2" class="accordion-collapse collapse" aria-labelledby="flush-headingTwo2"
              ...
              <div class="accordion-body">
                <ul class="fa-ul text-primary">
                  <li><span class="fa-li"><i class="fas fa-arrow-circle-right"></i></span> <a target="_blank"
                      class="text-decoration-none"
                      href="../vender/files/syllabus/TY_BTech_Mech2022.pdf">T.Y - B. Tech
                      (Mechanical Engineering)</a></li>
                </ul>
              </div>
            </div>
            ...
            <div id="flush-collapseThree2" class="accordion-collapse collapse" aria-labelledby="flush-headingThree2"
              ...
              <div class="accordion-body">
                <ul class="fa-ul text-primary">
                  <li><span class="fa-li"><i class="fas fa-arrow-circle-right"></i></span> <a target="_blank"
                      class="text-decoration-none"
                      href="../vender/files/time_table/T. Y. B.Tech-  (Mechanical Engineering).pdf">T.E - Bachlor of Engineering
                      (Mechanical
                      Engineering)</a></li>
                </ul>
              </div>
                ...
                <div class="container p-2 mt-1 class-teacher">
                  <div class="container-fluid content-panel">
                    <div class="row justify-content-around">
                      <div class="col-lg-3 col-sm-6">
                        <div class="item  text-center">
                          <div class="text-center"><img src="../faculty photo\Gaffar_G._Momin.jpg" alt = "Mr. S. S. Mule Photo"></div>
                      ...
                      <div class="col-lg-3 col-sm-6">
                        <div class="item    text-center">
                          <div class="text-center"><img src="../faculty photo\GDKale.jpg"></div>
                          <h6 class="h6 text-center">Mr. G. D. Kale</h6>
                ...
                <div class="container p-2 mt-1 class-teacher">
                  <div class="container-fluid content-panel">
                    <div class="row justify-content-around">
                      <div class="col-lg-3 col-sm-6">
                        <div class="item  text-center">
                          <div class="text-center"><img src="../people/Staff Photo/Madhukar Landge.jpg"></div>
                          <h6 class="h6 text-center">Mr. M. N. Landge</h6>
                          <p class="batch">~ BE Division-A</p>
                        </div>
                      </div>
                      <div class="col-lg-3 col-sm-6">
                        <div class="item    text-center">
                          ...
                          <h6 class="h6 text-center">M'. K. T. Mhaske</h6>
                          <p class="batch">~ BE Division-B</p>
                        </div>
                      </div>
                      <div class="col-lg-3 col-sm-6">
            ...
            <div id="flush-collapse2ac" class="accordion-collapse collapse" aria-labelledby="flush-heading2ac"
              ...
              <div class="accordion-body">
                <ul class="fa-ul text-primary">
                  ...
                  <li><span class="fa-li"><i class="fas fa-arrow-circle-right"></i></span> <a target="_blank"
                      class="text-decoration-none"
                      href="../vender/files/activity_calendar/Event Calendar_BE_2019 Patt.pdf">Activity Calendar of
                      the Institute for BE.</a></li>
                </ul>
              </div>
            </div>
            ...
            <div id="flush-collapseThree3" class="accordion-collapse collapse" aria-labelledby="flush-headingThree3"
              ...
              <div class="accordion-body">
                <ul class="fa-ul text-primary">
                  <li><span class="fa-li"><i class="fas fa-arrow-circle-right"></i></span> <a target="_blank"
                      class="text-decoration-none"
                      href="../vender/files/time_table/B.E.-Bachelor of Engineering (Mechanical Engineering).pdf">B.E - Bachlor
                      of Engineering
                      (Mechanical Engineering)</a></li>
                </ul>
              </div>
