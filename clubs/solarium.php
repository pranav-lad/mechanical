        ...
        <div class="bg-light shadow rounded p-3">
          ...
          <div class="row justify-content-center my-3">
            <div class="col-lg-9 col-md-12 text-start">
              ...
              <p class="my-4 text-dark"><br><br>
                With the help of our Faculty Coordinator, <span class="fw-bold">
                <!-- Dr. Anindita Roy -->
                Dr. Jaya Goyal
                </span>, 
            ...
            <div class="col-lg-2 col-md-6 justify-content-center">
              <div class="card mt-2 shadow-sm">
                <img src="../faculty photo/jaya goyal.jpg" style = "height: 230px; object-fit:cover;" class="card-img shadow-sm" alt="Image of faculty advisor of Team ambush">
                <div class="card-body">
